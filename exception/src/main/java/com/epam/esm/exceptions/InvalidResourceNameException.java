...
public class InvalidResourceNameException extends GlobalResourceException {
     ...
     * @since 1.4
     */
    public InvalidResourceNameException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public InvalidResourceNameException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    protected InvalidResourceNameException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
